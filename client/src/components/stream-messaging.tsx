  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-1">
        <span
          className={`text-sm ${
            isUnread ? "font-bold text-gray-900" : "text-gray-600"
          }`}
        >
          {senderName}
        </span>
      ...
      <h4
        className={`text-sm mb-1 ${isUnread ? "font-bold" : "text-gray-700"}`}
      >
        {subject}
      </h4>
    ...
    const initializeClient = async () => {
      ...
      try {
        ...
        toast({
          ...
          description:
            "Please add your Stream Chat API key and secret to environment variables.",
          variant: "destructive",
        });
      }
    };
