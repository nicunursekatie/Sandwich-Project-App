...
export default function SimpleNav({
  ...
  try {
    ...
    const navigationItems: NavigationItem[] = [
      ...
      // DOCUMENTATION
      ...(hasPermission(user, PERMISSIONS.DOCUMENTS_MANAGE) ||
      hasPermission(user, PERMISSIONS.DOCUMENTS_VIEW)
        ? [
            {
              id: 'documents',
      ...
      ...(hasPermission(user, PERMISSIONS.ANALYTICS_VIEW)
        ...
        : []),
      ...(hasPermission(user, PERMISSIONS.WORK_LOGS_ADD)
        ? [
            {
              id: 'work-log',
              label: 'Work Log',
                ...
                <Badge
                  ...
                  className={`${
                    isCollapsed
                      ...
                      : 'ml-auto h-4 sm:h-5 px-1 sm:px-1.5 min-w-[20px] text-xs'
