...
export default function LogosPage() {
  const [selectedLogo, setSelectedLogo] = useState<typeof logoFiles[0] | null>(null);
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <div className="border-b border-[#236383]/20 pb-4">
        ...
        <p className="text-[#646464] mt-2">
          Download official logos for use in presentations, documents, and communications.
          All logos are available for free use by volunteers and partner organizations.
        </p>
      </div>
      ...
      <Card className="border-[#236383]/20">
        <CardHeader>
          <CardTitle className="text-[#236383]">Download Complete Logo Package</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-[#646464] mb-4">
            Need all logos? Download each one individually using the buttons above, or contact your administrator for a complete package.
          </p>
